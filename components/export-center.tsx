...
export default function ExportCenter() {
  ...
  async function importLexoBooksEdition(file: File) {
    ...
    try {
      ...
      const response = await fetch(`/api/issues/${encodeURIComponent(issue.id)}/lexobooks-edition`, {
        method: "POST",
        headers: {
