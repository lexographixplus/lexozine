...
export default function DigitalEdition({ initialIssue }: { initialIssue?: Issue }) {
  ...
  function renderBlock(block: StoryBlock, columns: 1 | 2 | 3) {
    ...
    if (block.type === "subheading") return <div key={block.id} className="edition-composer-block edition-composer-subheading" style={style} dangerouslySetInnerHTML={{__html:block.content}}/>;
