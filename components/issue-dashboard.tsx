...
export default function IssueDashboard() {
  ...
  async function createIssue(kind: "editorial" | "culture" | "minimal") {
    ...
    window.location.href = `/?issue=${saved.id}`;
  }
